  ...
  return (
    <section className="relative bg-ink text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-container mx-auto px-10 pt-[80px] pb-[80px]">
        ...
        <div className="grid grid-cols-[1.2fr_1fr] gap-16 items-center mt-12">
          ...
          <motion.div variants={scaleIn} initial="hidden" animate="show">
            ...
            >
              ...
              {/* Glass info tag */}
              <div
                className="absolute bottom-5 left-5 right-5 px-5 py-4 rounded-[12px]"
...
function AboutLede() {
  return (
    <section className="px-10 py-24 bg-paper">
      <div className="max-w-[1100px] mx-auto grid grid-cols-[180px_1fr] gap-16">
        ...
        <motion.div variants={stagger} initial="hidden" whileInView="show" viewport={viewport}>
          ...
          >
            <span
              className="float-left font-semibold text-brand mr-3.5"
              style={{ fontSize: '4.5em', lineHeight: 0.88, marginTop: 6 }}
            >
              D
            </span>
          ...
          <motion.p variants={fadeUp} className="mt-8 text-[17px] leading-[1.7] text-ink-3">
          ...
          <motion.p variants={fadeUp} className="mt-6 text-[17px] leading-[1.7] text-ink-3">
          ...
          {cards.map((c, i) => {
            ...
            return (
              <motion.div
                ...
                className="rounded-r-lg p-9 min-h-[340px] flex flex-col gap-5"
                style={{
              ...
              >
                <div className="flex justify-between items-center">
                  <span
                    ...
                    style={{ color: isBrand ? '#1a1a1a' : '#f7941d' }}
                  >
                    — {c.tag}
                  </span>
                ...
                <h3
                  className="text-[26px] font-semibold tracking-[-0.01em] leading-[1.15]"
                  style={{ color: isBrand ? '#0a0a0a' : '#fff' }}
                >
                  {c.title}
                </h3>
                <p
                  className="text-[15px] leading-[1.6] flex-1"
                  style={{ color: isBrand ? 'rgba(10,10,10,0.75)' : 'rgba(255,255,255,0.6)' }}
                >
                  {c.body}
                </p>
              </motion.div>
        ...
        <motion.div variants={stagger} initial="hidden" whileInView="show" viewport={viewport} className="border-t-2 border-ink">
          {reasons.map(([t, b], i) => (
            <motion.div
              key={t}
              variants={fadeUp}
              className="grid grid-cols-[80px_1fr_2fr] gap-10 py-8 border-b border-line group hover:bg-paper-2 transition-colors duration-200 px-2 -mx-2 rounded"
            >
              <div className="font-mono text-[12px] text-brand-dark font-medium">0{i + 1}</div>
              <h3 className="text-[20px] font-semibold tracking-[-0.01em] group-hover:text-brand-dark transition-colors">{t}</h3>
              <p className="text-ink-3 text-[16px] leading-[1.6]">{b}</p>
            </motion.div>
          ))}
        </motion.div>
      </div>
